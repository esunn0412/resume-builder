// ============================================================================
// resume.typ — layout/styling ONLY. All actual content lives in resume-swe.yaml.
// Edit resume-swe.yaml to update your resume; this file defines how it looks.
// ============================================================================

#let data = yaml("resume-swe.yaml")
